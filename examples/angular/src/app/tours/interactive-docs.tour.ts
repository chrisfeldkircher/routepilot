...
const docsGifIntroStep: StepDefinition = {
  ...
  content: {
    ...
    media: {
      src: 'https://media.giphy.com/media/NFA61GS9qKZ68/giphy.gif',
      alt: 'A cat studying an open book, eyes tracking the page — the ideal docs reader (rarely the real one)',
      loading: 'eager',
    },
  },
};
