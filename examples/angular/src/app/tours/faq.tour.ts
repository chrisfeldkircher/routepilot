...
import { pickupState } from '../state/pickupState';
...
const faqIntroStep: StepDefinition = {
  ...
  content: {
    ...
    media: {
      ...
      alt: 'A man counting on his fingers while math formulas and equations swirl around his head, looking confused',
      loading: 'eager',
    },
  },
};
...
export const faqTour: TourDefinition = {
  id: 'pickup-faq',
