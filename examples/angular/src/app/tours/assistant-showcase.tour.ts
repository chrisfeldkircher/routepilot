...
const outroStep: StepDefinition = {
  ...
  content: {
    ...
    body: '==|npm i @routepilot/assistant @routepilot/assistant-angular|==\n\nProvide the index and the assistant config:\n\n==|TourIndex.fromTours([onboardingTour, faqTour, assistantShowcaseTour])|==\n==|{ provide: TOUR_ASSISTANT_CONFIG, useValue: { index, queryOptions: { scope: \'current-tour-only\' } } }|==\n\nThen project the button and prompt into the overlay footer slots:\n\n==|<rp-guided-tour-overlay>|==\n==|  <rp-tour-assistant-prompt rpTooltipFooter></rp-tour-assistant-prompt>|==\n==|  <rp-tour-assistant-button rpTooltipFooterNav></rp-tour-assistant-button>|==\n==|</rp-guided-tour-overlay>|==\n\nThe slots are ==generic== — the overlay has no assistant knowledge. Drop the dep, remove the projected components, tooltip footer looks exactly like before.\n\nHit ==|Finish|==. Your FAQ just got a search bar.',
  },
};
...
export const assistantShowcaseTour: TourDefinition = {
  ...
  description:
    'Developer walkthrough of @routepilot/assistant-angular: BM25-ranked step retrieval wired into the tooltip footer.',
  steps: [
    introWhatStep,
    introTechStep,
    answerFileSizeStep,
